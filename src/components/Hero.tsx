        ...
        <div className="text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-4">
              <span className="gradient-text">Muna K.C.</span>
            </h1>
          ...
          >
            <Button
              ...
              className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 text-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
            >
            ...
            <Button
              ...
              className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground px-8 py-6 text-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
            >
              Learn More
